...
export async function fetchCourseInformation({ courseId }) {
  try {
    const response = await fetch(
      ...
      `students.groups.qualifications.file,students.groups.qualifications.activity, students.groups.users,students.groups.users.profile_photo, students.groups.activity`);
