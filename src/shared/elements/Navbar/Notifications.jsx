...
export const Notifications = () => {
    ...
    const content = (
        <div className='w-[25rem] h-[25rem] max-w-[88vw] overflow-y-auto overflow-x-hidden px-3'>
            <hr className='mb-3' />
            {
    ...
    return (
        <Popover id='notifacations-popover' content={content} title={contentTitle} trigger="click">
