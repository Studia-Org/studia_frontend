...
export const Sidebar = (props) => {
    ...
    return (
        <>
            ...
            <aside id="default-sidebar" class="absolute  pt-10 sm:pl-16 top-0 left-0 z-40 w-80 md:mt-10 transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
