...
export const WebchatChatbot = () => {
    ...
    const configuration = {
        ...
        botAvatar: 'https://www.solidbackgrounds.com/images/950x350/950x350-indigo-solid-color-background.jpg',
        botDescription:
            'Hi! 👋  Welcome to uptitude webchat, your personalized assistant powered by your data for all things learning.',
        email: {
    ...
    return (
        ...
        <>
            ...
            <Drawer onClose={onClose} open={open} width={'500px'} headerStyle={{ display: 'none' }}>
                <WebchatProvider
