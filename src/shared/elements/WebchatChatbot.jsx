    ...
    return (
        <>
            <button
                ...
                className="fixed right-8 bottom-12 items-center justify-center ml-auto w-[3.2rem] h-[3.2rem] text-white transition !bg-[#3c3c3c] rounded-full shadow-xl hover:!bg-[#4f4f4f] duration-100 hover-scale active-scale"
                onClick={showDrawer}
            >
