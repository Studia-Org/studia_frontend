                        ...
                        <form onSubmit={loginAccount} className="z-50 w-full px-5 py-10 md:w-1/2 md:px-10">
                            ...
                            <div>
                                ...
                                <div className='flex justify-end w-full'>
                                    <button type='button' onClick={() => setForgotPasswordFlag(true)} className='flex justify-end mb-12 text-xs'>Forgot password?</button>
                                </div>
                                ...
                                <div className='flex flex-col items-center text-center'>
                                    ...
                                    <p className='mt-2 text-xs'>Contact support: uptitudeapp@gmail.com</p>
                                </div>
                            </div>
                        </form>
                    </div>
