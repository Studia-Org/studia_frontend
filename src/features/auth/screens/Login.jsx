            ...
            <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5 bg-gradient-to-r from-indigo-400  to-[#6e66d6]">
                <div className="w-full overflow-hidden text-gray-500 bg-gray-100 shadow-xl rounded-3xl " style={{ maxWidth: '1000px' }} >
                    ...
                    <div className="z-50 w-full md:flex">
                        <div className="relative z-50 hidden w-1/2 px-10 py-10 md:block bg-image">
                            ...
                            <div className='flex justify-center'>
                                <div className='absolute w-2/4 top-48 '>
                                    <h1 className='text-4xl font-medium text-white '>{t("LOGIN.card_title")}</h1>
                                    <p className='py-3 text-white '>{t("LOGIN.card_text")}</p>
                                </div>
                            </div>
                            <div className='absolute inset-x-0 flex flex-col items-center bottom-7'>
                                <p className='text-xs text-center text-white' >{t("LOGIN.in_case_register")}</p>
                        ...
                        <form onSubmit={loginAccount} className="z-50 w-full px-5 py-10 md:w-1/2 md:px-10">
                            <div className="mb-10 text-center">
                                <h1 className="text-3xl font-bold text-gray-900">{t("LOGIN.login")}</h1>
                                <p>{t("LOGIN.enter_information")}</p>
                            </div>
                            <div>
                                <div className="z-50 flex -mx-3">
                                    <div className="z-50 w-full px-3 mb-5">
                                        <label htmlFor="" className="px-1 text-xs font-semibold">{t("LOGIN.email")}</label>
                                        <div className="flex">
                                ...
                                <div className="flex -mx-3">
                                    <div className="relative w-full px-3 mb-2">
                                        <label htmlFor="" className="px-1 text-xs font-semibold">{t("LOGIN.password")}</label>
                                        <div className="flex">
                                ...
                                <div className='flex justify-end w-full'>
                                    <button type='button' onClick={() => setForgotPasswordFlag(true)} className='flex justify-end mb-12 text-xs'>{t("LOGIN.forgot_password")}</button>
                                </div>

                                <div className="flex justify-center mb-5 pt-7">
                                    <div className="w-full mb-5 text-center sm:ml-8 sm:pr-8">
                                        <button type='submit' className="inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                                ...
                                <div className='flex flex-col items-center text-center'>
                                    <p className='text-xs'>{t("LOGIN.connect_social")}</p>
                                    <Button disabled className="my-2 text-white bg-[#4285F4]  focus:ring-4 
                                    ...
                                    <p className='mt-2 text-xs'>{t("LOGIN.contact_support")} uptitudeapp@gmail.com</p>
                                </div>
                            </div>
                        </form>
                    </div>
