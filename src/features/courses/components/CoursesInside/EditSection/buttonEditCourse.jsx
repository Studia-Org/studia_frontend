...
export function ButtonSettings({ setSettingsFlag, setVisible, setForumFlag }) {
    return (
        <button onClick={() => { setSettingsFlag(true); setForumFlag(false); if (setVisible) setVisible(false) }} className="bg-white p-3 rounded-md shadow-md flex items-center w-full border-gray-500 border-solid border-2 xl:border-none xl:w-[30rem]">
