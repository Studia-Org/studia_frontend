...
export const SubsectionList = ({ subsection, setSectionToEditTemp, setSubsectionEditing, editable = false, danger = false }) => {
    ...
    function deleteSubsection() {
        ...
        setSectionToEditTemp((prev) => {
            ...
            deleted = updatedSubsections.length === prev.attributes.subsections.data.length - 1
            return {
                ...prev,
                attributes: {
                    ...prev.attributes,
        ...
        if (deleted) message.success('Subsection deleted successfully');
    ...
    return (
        <li
            ...
            style={style}
            className="cursor-pointer mb-10 ml-8 mt-8 flex items-center h-[2rem] w-[35rem] max-w-[100%] relative">
            <div className='absolute -top-2 border-y border-l rounded-md  bg-gray-50 h-[3rem] w-[40rem] max-w-[100%] -left-14 '>
            </div>
            <span
                ref={setNodeRef}
                {...listeners}
                className={`${switchFaseColor(subsection.attributes.fase)} absolute flex items-center justify-center w-8 h-8  rounded-full -left-12  ring-white `}>
            ...
            <div className="flex items-center gap-x-3 justify-between w-[calc(100%+4rem)] bg-gray-50 min-h-[3rem] -left-14 rounded-md border">
                <div className="flex items-center gap-2 ">
                    <div className="z-50 flex flex-col justify-center ml-5">
                ...
                {danger &&
                    <i className='z-50 flex justify-end flex-1'>
