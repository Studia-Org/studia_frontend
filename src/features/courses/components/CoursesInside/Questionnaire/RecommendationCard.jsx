    ...
    return (
        <div className='relative mt-5'>
            <List
                header={
                    <div>
                        <h3 className='text-base font-medium'>{t("CREATE_COURSES.COURSE_SECTIONS.EDIT_SECTION.SEQUENCES.ELEMENTS.QUESTIONNAIRE_DATA.SRLO.RECOMMENDATION.text")}</h3>
                ...
                renderItem={(item) => (
                    <List.Item>
                        <Typography.Text mark>[{t("CREATE_COURSES.COURSE_SECTIONS.EDIT_SECTION.SEQUENCES.ELEMENTS.QUESTIONNAIRE_DATA.SRLO.RECOMMENDATION.recommendation")}]</Typography.Text> {item}
                    </List.Item>
                )}
            />
