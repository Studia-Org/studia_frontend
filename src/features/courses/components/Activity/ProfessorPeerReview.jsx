      ...
      <div className='mx-5'>
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
          <div className="flex items-center justify-between p-5 pb-4 bg-white">
            ...
            <Button onClick={() => generateExcelPeerReview(courseContentInformation.students.data, peerReviewAnswers, activityToReviewID)} type="default" className='flex items-center gap-x-1'>
              Download all
