    ...
    return (
        <div className="w-full max-w-sm overflow-hidden rounded-lg shadow-md bg-gray-50 ">
                ...
                <div className='absolute w-full h-full bg-black opacity-20 '></div>
                {
                    courseData.new && (
                        <div className='absolute top-4 right-4'>
                            ...
                            bg-blue-100 text-blue-800 ">{t("COMMON.new")}</span>
            ...
            <div className="px-6 py-4">
                ...
                <p className='mt-4 mb-2 text-xs text-gray-400'>{t("COURSESHOME.student_creation_courses.about_creator")}</p>
                        ...
                        <h1 className="mb-1 font-medium">{courseData.creator}</h1>
                        {
                            courseData.verified && (
                                <span class="ml-auto inline-flex items-center justify-center w-6 h-6 me-2 text-sm font-semibold text-blue-800 bg-blue-100 rounded-full ">
                                    ...
                                    <span class="sr-only">{t("COURSESHOME.student_creation_courses.icon_description")}</span>
                                </span>
                            )
                        }
                    </div>
                ...
                <Button disabled onClick={() => handleClick()} className='w-full mt-4 bg-white'>
                    {t("COURSESHOME.student_creation_courses.customize_course")}
                </Button>
            </div>
