...
export const ContentObjectiveInformation = ({ user, propsObjectives }) => {
    ...
    if (propsObjectives.categories.includes('Learning capability and responsibility')) {
        ...
        const content = validQualifications && validQualifications.length > 0 ?
            <Trans i18nKey="OBJECTIVES_INFORMATION.LEARNING_CAPABILITY.description_with_qualifications" components={{
                "qualificationsCount": validQualifications.length,
                "averageGrade": (validQualifications.reduce((acc, curr) => acc + curr.qualification, 0) / validQualifications.length).toFixed(2),
            }} />
            :
            t("OBJECTIVES_INFORMATION.LEARNING_CAPABILITY.description_no_qualifications")
        data.push({
            title: t("OBJECTIVES_INFORMATION.LEARNING_CAPABILITY.title"),
            description: content,
            avatar:
    ...
    if (propsObjectives.categories.includes('Teamwork')) {
        ...
        const content = teamWorkActivities && teamWorkActivities.length > 0 ?
            <Trans i18nKey="OBJECTIVES_INFORMATION.TEAMWORK.description_with_activities" components={{
                "activitiesCount": teamWorkActivities.length,
                "averageGrade": teamWorkAverage
            }} />
            :
            t("OBJECTIVES_INFORMATION.TEAMWORK.description_no_activities")
        data.push({
            title: t("OBJECTIVES_INFORMATION.TEAMWORK.title"),
            description: content,
            avatar:
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
    ...
    if (propsObjectives.categories.includes('Ethical commitment')) {
        const content = t("OBJECTIVES_INFORMATION.ETHICAL_COMMITMENT.description");
        data.push({
            title: t("OBJECTIVES_INFORMATION.ETHICAL_COMMITMENT.title"),
            description: content,
            avatar:
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
    ...
    if (propsObjectives.categories.includes('Creative and entrepreneurial capacity')) {
        const content = t("OBJECTIVES_INFORMATION.CREATIVE_CAPACITY.description");
        data.push({
            title: t("OBJECTIVES_INFORMATION.CREATIVE_CAPACITY.title"),
            description: content,
            avatar:
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
    ...
    if (propsObjectives.categories.includes('Sustainability')) {
        const content = t("OBJECTIVES_INFORMATION.SUSTAINABILITY.description");
        data.push({
            title: t("OBJECTIVES_INFORMATION.SUSTAINABILITY.title"),
            description: content,
            avatar:
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
    ...
    if (propsObjectives.categories.includes('Communicative ability')) {
        const content = t("OBJECTIVES_INFORMATION.COMMUNICATIVE_ABILITY.description");
        data.push({
            title: t("OBJECTIVES_INFORMATION.COMMUNICATIVE_ABILITY.title"),
            description: content,
