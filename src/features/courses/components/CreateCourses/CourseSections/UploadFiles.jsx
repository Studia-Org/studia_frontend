...
export const UploadFiles = ({ fileList, setFileList, listType, maxCount, accept, disabled, showRemoveIcon, styles }) => {
    ...
    return (
        <>
            <Upload.Dragger style={styles}  onRemove={handleRemove()} showUploadList={{
