...
export const CreateCourseSectionsList = ({ section, deleteSection, setEditCourseSectionFlag, setSectionToEdit }) => {
    ...
    return (
        <div style={style}
            className=' relative rounded-md bg-[#d3d7f2] text-gray-800 p-3 flex items-center'
        >
            <div
                {...attributes}
                {...listeners}
                ref={setNodeRef} className=' border-r pr-5 pl-2 items-center justify-center border-gray-800'>
